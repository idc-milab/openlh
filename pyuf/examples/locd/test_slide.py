...
ufc.node_init('tests', test_ports, test_iomap)
...
print('tests move: ', test_ports['linear_motion']['handle'].call('set pos 200 200'))
print('get pos: ', test_ports['linear_motion']['handle'].call('get pos'))
print('tests move: ', test_ports['linear_motion']['handle'].call('set pos 50 200'))
print('get pos: ', test_ports['linear_motion']['handle'].call('get pos'))
