...
height = 30.5  # Z-axis height for dispensing
...
def plot_points():
    ...
    for point in grid_points:
        plt.plot(point[0], point[1], 'ro', label='Deposits')  # 'ro' stands for red circles
    xl,yl,zl = l 
    plt.plot(xl, yl, 'bo',label='Cells tube')  # 'ro' stands for red circles
